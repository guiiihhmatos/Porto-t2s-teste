...
namespace PortoSP.Controllers
{
    public class ConteinersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,NomeCliente,Codigo,Tipo,Status,Categoria,TipoMovimentacao,DataInicio,DataFinal")] Conteiner conteiner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,NomeCliente,Codigo,Tipo,Status,Categoria,TipoMovimentacao,DataInicio,DataFinal")] Conteiner conteiner)
        {
            if (id != conteiner.ID)
            {
                return NotFound();
